...
export const TimewrappedSensei: EndOfTurnCard = {
	cardIds: [TempCardIds.TimewrappedSensei, TempCardIds.TimewrappedSensei_G],
	endOfTurn: (minion: BoardEntity, input: EndOfTurnInput) => {
		const mult = minion.cardId === TempCardIds.TimewrappedSensei_G ? 2 : 1;
