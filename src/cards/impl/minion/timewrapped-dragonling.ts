...
export const TimewrappedDragonling: StartOfCombatCard = {
	cardIds: [TempCardIds.TimewrappedDragonling, TempCardIds.TimewrappedDragonling_G],
	startOfCombatTiming: 'start-of-combat',
	startOfCombat: (minion: BoardEntity, input: SoCInput) => {
		const mult = minion.cardId === TempCardIds.TimewrappedDragonling_G ? 2 : 1;
