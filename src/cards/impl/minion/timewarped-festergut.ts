...
export const TimewarpedFestergut: DeathrattleSpawnCard = {
	cardIds: [CardIds.TimewarpedFestergut_BG34_Giant_590, CardIds.TimewarpedFestergut_BG34_Giant_590_G],
	deathrattleSpawn: (minion: BoardEntity, input: DeathrattleTriggeredInput) => {
		const mult = minion.cardId === CardIds.TimewarpedFestergut_BG34_Giant_590_G ? 2 : 1;
