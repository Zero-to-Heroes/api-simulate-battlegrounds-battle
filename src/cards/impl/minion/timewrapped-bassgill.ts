...
export const TimewrappedBassgill: DeathrattleSpawnCard = {
	cardIds: [TempCardIds.TimewrappedBassgill, TempCardIds.TimewrappedBassgill_G],
	deathrattleSpawn: (minion: BoardEntity, input: DeathrattleTriggeredInput) => {
		const mult = minion.cardId === TempCardIds.TimewrappedBassgill_G ? 2 : 1;
