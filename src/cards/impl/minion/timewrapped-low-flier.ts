...
export const TimewrappedLowFlier: EndOfTurnCard = {
	cardIds: [TempCardIds.TimewrappedLowFlier, TempCardIds.TimewrappedLowFlier_G],
	endOfTurn: (minion: BoardEntity, input: EndOfTurnInput) => {
		const mult = minion.cardId === TempCardIds.TimewrappedLowFlier_G ? 2 : 1;
