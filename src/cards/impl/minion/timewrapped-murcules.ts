...
export const TimewrappedMurcules: OnMinionKilledCard = {
	cardIds: [TempCardIds.TimewrappedMurcules, TempCardIds.TimewrappedMurcules_G],
	onMinionKilled: (minion: BoardEntity, input: OnMinionKilledInput) => {
		const mult = minion.cardId === TempCardIds.TimewrappedMurcules_G ? 2 : 1;
