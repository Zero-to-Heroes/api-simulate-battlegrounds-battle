...
export const TimewrappedShoal: SpellCard = {
	cardIds: [TempCardIds.TimewrappedShoal, TempCardIds.TimewrappedShoal_G],
	castSpell: (spellCardId: string, input: CastSpellInput) => {
		const mult = spellCardId === TempCardIds.TimewrappedShoal_G ? 2 : 1;
